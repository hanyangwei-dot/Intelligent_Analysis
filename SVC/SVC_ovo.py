...
# 线性核 SVM
svm_linear1 = ovo(C=1.0, kernel='linear')
svm_linear2 = ovo(C=100.0, kernel='linear')

# RBF 核 SVM（gamma 默认为 0.1）
svm_rbf1 = ovo(C=1.0, kernel='rbf', γ=0.1)
svm_rbf2= ovo(C=1.0, kernel='rbf', γ=0.1)
# ==============================
# 4. 训练模型
# ==============================
print("开始训练线性核SVM...")
...
# print(f"\n【RBF 核 SVM2 测试准确率】: {acc_rbf1 * 100:.2f}%")
